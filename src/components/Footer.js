      ...
      <div ref={ref} className="w-full flex flex-col items-center">
        ...
        >
          ...
          >
            ...
            <motion.div className="flex-1 min-w-[250px]" variants={itemVariants}>
              <Link href="index.html" className="flex items-center mb-6">
                <span className="text-3xl md:text-4xl  font-bold tracking-wide">CLI-X</span>
              </Link>
            ...
            >
              ...
              <ul className="space-y-2 text-white/60">
                ...
                <li>
                  <Link href="#">Software Consultancy</Link>
                </li>
                <li>
