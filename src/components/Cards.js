                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="rounded-3xl">
                                            ...
                                            <path fill="#3B3B3B" d="M0,256L18.5,261.3C36.9,267,74,277,111,245.3C147.7,213,185,139,222,128C258.5,117,295,171,332,208C369.2,245,406,267,443,240C480,213,517,139,554,106.7C590.8,75,628,85,665,106.7C701.5,128,738,160,775,176C812.3,192,849,192,886,202.7C923.1,213,960,235,997,240C1033.8,245,1071,235,1108,197.3C1144.6,160,1182,96,1218,80C1255.4,64,1292,96,1329,117.3C1366.2,139,1403,149,1422,154.7L1440,160L1440,320L0,320Z"></path>
                                            <path fill="none" stroke="url(#strokeGradient)" strokeWidth="15" d="M0,256L18.5,261.3C36.9,267,74,277,111,245.3C147.7,213,185,139,222,128C258.5,117,295,171,332,208C369.2,245,406,267,443,240C480,213,517,139,554,106.7C590.8,75,628,85,665,106.7C701.5,128,738,160,775,176C812.3,192,849,192,886,202.7C923.1,213,960,235,997,240C1033.8,245,1071,235,1108,197.3C1144.6,160,1182,96,1218,80C1255.4,64,1292,96,1329,117.3C1366.2,139,1403,149,1422,154.7L1440,160"></path>
                                        </svg>
                                    </div>
                            ...
                            <motion.div
                                ...
                                <div className="flex gap-2 py-8 overflow-x-auto scrollbar-hide w-full whitespace-nowrap hide-scrollbar px-3">
                                    <div className="bg-[#ffffff] rounded-xl p-5 flex flex-col gap-1 min-w-[80%]">
                                        ...
                                        <p className="text-gray-500 text-[14px]">Prioritizing top-tier performance</p>
                                    </div>
                                    ...
                                    <div className="bg-[#ffffff] rounded-xl p-5 flex flex-col gap-1 min-w-[90%]">
                                        ...
                                        <p className="text-gray-500 text-[14px]">Scalable hosting tailored for growing businesses</p>
                                    </div>

                                    <div className="bg-[#ffffff] rounded-xl  p-5 flex flex-col gap-1 min-w-full">
                                        <h4 className="text-black text-[16px] font-bold">Gold</h4>
                                        <p className="text-gray-500 text-[14px]">Balanced hosting solution for small to medium-sized web.</p>
                                    </div>
                                </div>
