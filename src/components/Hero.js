                ...
                <div className="container md:w-[90%] 2xl:w-[80%] mx-auto relative z-[3] px-3 w-full font-montserrat" data-aos="fade-up" data-aos-delay="100">
                    <div className="flex flex-wrap justify-between gap-y-10">
                        <div className="w-full lg:w-1/2 order-2 lg:order-1 flex flex-col justify-center">
                            ...
                            <div className="flex">
                                <Link href="#contact" className="text-[#ffffff] bg-[rgba(255,255,255,0.1)] font-medium text-sm tracking-wider inline-block py-3.5 px-10 rounded-full border-2 border-[rgba(255,255,255,0.1)] transition duration-300 hover:border-[var(--default-color)/40]">Get Started</Link>
                            </div>
                        </div>
